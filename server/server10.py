...
tcp_port = 8085
lamp1 = 'http://192.168.0.101/api/tNpRZeZwa9QzHrEebHws8wXYT10SzEYlzQRXUOdO/lights/1/state'
lamp2 = 'http://192.168.0.101/api/tNpRZeZwa9QzHrEebHws8wXYT10SzEYlzQRXUOdO/lights/2/state'
lamp3 = 'http://192.168.0.101/api/tNpRZeZwa9QzHrEebHws8wXYT10SzEYlzQRXUOdO/lights/3/state'
...
class MyHandler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if command == "on" or command == "off":
            ...
            if command == "on":
            #        if arg != "":
                data = '{"on":true, "sat":254, "bri":100,"hue":'+ arg +'}'
            #        else:
            #            data = '{"on":true}'
                if deviceid == "1":
